    ...
    fluidRow(
      column(12, 
             wellPanel(
               selectInput("country",
                           "Select Country",
                           choices = as.list(c("United-States", "Canada", "Mexico", "Germany", "Philippines")),
    ...
    fluidRow(
      column(3, 
             wellPanel(
               ...
               checkboxInput("is_stacked", "Stacked Bar", value = FALSE, width = NULL)     # add check box input for stacked bar chart option
             )
      ),
